      ...
      subcommands: {
        ...
        disable: {
          ...
          execute: async ({ client, interaction }) => {
            ...
            if (channel!.type !== "GUILD_TEXT")
            ...
            else if (guildInfo?.prefab?.disabledChannels?.includes(channel!.id))
              embed.setDescription(
              ...
              embed.setDescription(
                `${interaction.user}, the channel ${channel} has been disabled.`
              );
            }
        ...
        enable: {
          ...
          execute: async ({ client, interaction }) => {
            ...
            if (channel!.type !== "GUILD_TEXT")
              ...
              !guildInfo?.prefab?.disabledChannels?.includes(channel!.id)
            )
              embed.setDescription(
              ...
              embed.setDescription(
                `${interaction.user}, the channel ${channel} has been enabled.`
              );
            }
