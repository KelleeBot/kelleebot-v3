    ...
    super(client, {
      ...
      execute: async ({ client, interaction }) => {
        ...
        try {
          ...
          switch (action) {
            case "add":
              ...
              if (userInfo.isBlacklisted)
                return interaction.reply({
                  content: `Looks like **${user.tag}** is already blacklisted.`
                });
              ...
              interaction.reply({
                content: `**${user.tag}** has successfully been blacklisted.`
              });
              break;
            case "remove":
              if (!userInfo.isBlacklisted)
                return interaction.reply({
                  content: `**${user.tag}** is currently not blacklisted.`
                });
              ...
              interaction.reply({
                content: `**${user.tag}** has successfully been whitelisted.`
              });
              break;
          }
        } catch (e) {
          ...
          return interaction.reply({
            content: `An error occurred and **${user.tag}** was not ${
              action === "add" ? "blacklisted" : "whitelisted"
            }.`,
            ephemeral: true
          });
        }
