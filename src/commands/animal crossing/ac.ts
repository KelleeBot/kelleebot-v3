...
import {
  ...
  tool,
  villager
} from "../../subcommandHelpers/animal crossing";
  ...
  constructor(client: Client) {
    super(client, {
      ...
      subcommands: {
        ...
        diy: {
          description:
            "Retrieve information about a specific diy/recipe in Animal Crossing: New Horizons.",
          options: [
            {
              name: "diy",
              description:
        ...
        dream: {
          description:
            "Show's the server owner's ACNH dream address, if they have one set.",
          execute: async ({ client, interaction }) => {
            await this.setCooldown(interaction);
            ...
            if (!guildInfo.dreamAddress)
              return interaction.reply({
                content:
                  "Looks like the server owner has not set their dream address yet."
              });

            const owner = await interaction.guild?.fetchOwner();
            return interaction.reply({
              content: `${owner?.user.username}'s ACNH dream address is ${guildInfo.dreamAddress}.`
            });
          }
        },
        fish: {
        ...
        item: {
          description:
            "Retrieve information about a miscellaneous item in Animal Crossing: New Horizons.",
          options: [
            {
              name: "item",
              description:
                "The name of the item you wish to retrieve information about.",
              type: "STRING",
              required: true,
              autocomplete: true
            }
          ...
          options: [
            {
              name: "tool",
              description:
                "The name of the tool item you wish to retrieve information about.",
              type: "STRING",
              required: true,
              autocomplete: true
            }
          ...
          options: [
            {
              name: "name",
              description:
                "The name of the villager you wish to retrieve information about.",
              type: "STRING",
              required: true,
              autocomplete: true
            }
