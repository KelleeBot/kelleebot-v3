                ...
                try {
                    ...
                    if (!regex)
                        return await interaction.reply({
                            content: "Friend code is of invalid format. Format must be in `SW-1234-1234-1234`.",
                            ephemeral: true
                        });
                    ...
                    return await interaction.reply({
                        content: `Your Nintendo Switch Friend Code has been successfully set to \`${code}\`.`,
                        ephemeral: true
                    });
                } catch (e) {
