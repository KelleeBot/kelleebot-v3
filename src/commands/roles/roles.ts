  ...
  constructor(client: Client) {
    super(client, {
      ...
      subcommands: {
        add: {
          ...
          options: [
            ...
            },
            {
              name: "channel",
              description:
                "The channel that the message is in. Default is current channel if none specified.",
              type: "CHANNEL",
        ...
        remove: {
          ...
          options: [
            ...
            },
            {
              name: "position",
              description:
                "The position in the dropdown that the role you want to remove is in.",
              type: "INTEGER",
              required: true,
              minValue: 1
            },
        ...
        send: {
          description:
            "Sends a message as the bot to be used for roles assignment.",
          options: [
            {
              name: "message",
            ...
            },
            {
              name: "channel",
              description:
                "The channel to send the message to. Default is current channel if none specified.",
              type: "CHANNEL",
              channelTypes: ["GUILD_TEXT"]
            }
          ],
