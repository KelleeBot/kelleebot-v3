...
import {
  ...
  scratch,
  slots
} from "../../subcommandHelpers/gambling";
  ...
  constructor(client: Client) {
    super(client, {
      ...
      subcommands: {
        ...
        points: {
          description:
            "Check how many points you or another user has and current ranking.",
          options: [
            {
              name: "user",
          ...
          options: [
            {
              name: "amount",
              description:
                "The amount of points (or all) to play scratch tickets with.",
              type: "STRING",
              required: true
            }
          ],
        ...
        slots: {
          description:
            "Test your luck and play the slots. Each slot win gives you 4 times the amount you bet.",
          options: [
            {
              name: "amount",
              description: "The amount of points (or all) to gamble.",
